...
public class Main {
    ...
    public static void main(String[] args){
        ...
        //TODO: Leer archivo de testing solo cuando la opcion testing esta activada.
        ...
        //Sospecho que hay un error en esta linea. Cuando se carga un objeto serializable
        //que corresponde a un ttosom ya entrenado, la estructura del arbol deberia estar implicita
        //por lo tanto no tiene sentido cargar la topologia desde un archivo independiente.
...
//        try{
//            System.out.println("Cross Validation"); //Paso 1: mensaje
//            
//            
//            Evaluation eval = new Evaluation(dataSet);//Paso 2: declarar objeto eval
//            
...
//        }
        Validation xfold = new TenFoldCrossValidation(folds, random, "crossValidation", ttosom, dataSet);
        xfold.validate();
    }
 
    private static void trainTestSet(){
//        try {
//            System.out.println("Training and test sets");//Paso 1: mensaje
//            
//            ttosom.buildClassifier(dataSet);
...
//        }
        Instances test = readArff(testingSetPath);
        Validation trainTest = new TrainTestSet("trainTestSet", ttosom, dataSet, test);
    }
